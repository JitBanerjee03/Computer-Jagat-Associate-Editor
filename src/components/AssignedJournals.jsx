                      ...
                      <div className="d-flex flex-wrap gap-1 align-items-center">
                        ...
                        {assignment.status !== 'completed' && (
                          <>
                            ...
                            >
                              <FaCheckCircle className="me-1" /> Rec
                            </Link>
                        ...
                        {/* Editor Recommendation Indicators */}
                        <div className="d-flex gap-1 ms-1">
                          <Button 
                            variant={assignment.chief_editor_recommendation ? "warning" : "outline-warning"} 
                            size="sm"
                            className="d-flex align-items-center"
                            title={assignment.chief_editor_recommendation ? 
                              "View Chief Editor Recommendation" : 
                              "Chief Editor Recommendation"}
                            onClick={() => handleRecommendationClick(assignment.journal_id, 'chief-editor')}
                          >
                            <FaCrown className="me-1" /> Chief
                          </Button>
                          <Button 
                            variant={assignment.area_editor_recommendation ? "success" : "outline-success"} 
                            size="sm"
                            className="d-flex align-items-center"
                            title={assignment.area_editor_recommendation ? 
                              "View Area Editor Recommendation" : 
                              "Area Editor Recommendation"}
                            onClick={() => handleRecommendationClick(assignment.journal_id, 'area-editor')}
                          >
                            <FaUserShield className="me-1" /> Area
                          </Button>
                          {/*<Button 
                            variant={assignment.associate_editor_recommendation ? "info" : "outline-info"} 
                            size="sm"
                            className="d-flex align-items-center"
                            title={assignment.associate_editor_recommendation ? 
                              "View Associate Editor Recommendation" : 
                              "No Associate Editor Recommendation"}
                            onClick={() => handleRecommendationClick(assignment.journal_id, 'associate-editor')}
                          >
